# Generated by Django 3.2 on 2023-02-13 18:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available_sizes', models.CharField(choices=[('S', 'S'), ('M', 'M'), ('L', 'L'), ('XL', 'XL'), ('XXL', 'XXL'), ('XXXL', 'XXXL')], default='L', max_length=4)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='shop_api.color'),
        ),
        migrations.AddField(
            model_name='cloth',
            name='length',
            field=models.ManyToManyField(to='shop_api.Length'),
        ),
        migrations.AddField(
            model_name='cloth',
            name='material_type',
